    ...
    function(e, t, n) {
        ...
        function a(e, n, r, i, s, a, f) {
            function l(t) {
				...
				/*
				console.log( "Registering for REMOVAL");
				console.log( "Element: " + c.getAttribute( "data ") );
				console.log( d );
				console.log( "c.readyState" );
				console.log( c.readyState );
				console.log( o(c.readyState) );
				console.log( "m and u() " );
				console.log( m );
				console.log( u() );
				console.log( "e" );
			...
			if ( e == "object" ) {
				...
				// console.log( e );
				// return;
				// This is a racing condition issue where object element remain in the DOM......    :'-(
			}
