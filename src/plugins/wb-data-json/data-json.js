...
var componentName = "wb-data-json",
	...
	functionForTest = {
		...
		"fn:guestType": function( value, rawValue ) {
			...
			if ( guestType && guestType !== "undefined" ) {
				if ( guestType === "@json" ) {
					guestType = "rdf:JSON";
				} else if ( $.isArray( guestType ) && guestType.indexOf( "@json" ) !== -1 ) {
					guestType[ guestType.indexOf( "@json" ) ] = "rdf:JSON";
				}
			}
